...
public class CsvParserSimple {
    ...
    public List<String[]> readFile(File csvFile, int skipLine)
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String[] csvLineInArray = parse(line, DEFAULT_SEPARATOR, DEFAULT_QUOTE_CHAR);
    ...
    // both functions left out because it gives an error:
    // incompatible types: Array is not a functional interface
/*
...
*/
    private String[] parse(String line, char separator, char quoteChar)
            throws Exception {
